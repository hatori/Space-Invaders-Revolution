    ...
    public class Input
    {
        ...
        private void setup_keys()
        {
            ...
            try
            {
                ...
                keys[8] = retrieve_key_type(((Form1)_form1_reference).main_settings.read_config_setting("Input", "key8")); ;
                keys[9] = retrieve_key_type(((Form1)_form1_reference).main_settings.read_config_setting("Input", "key9")); ;
            }
            catch
            {
                keys[0] = Key.Return;
